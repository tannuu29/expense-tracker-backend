    ...
    <div className="landing-container">
      <header className="landing-header-bar">
        ...
        <nav className="landing-header-nav">
          <a href="#" onClick={(e) => { e.preventDefault(); navigate('/about'); }} className="landing-nav-link">About</a>
          <a href="#" onClick={(e) => { e.preventDefault(); navigate('/contact'); }} className="landing-nav-link">Contact</a>
        </nav>
      ...
      <footer className="landing-footer">
        <div className="footer-content">
          ...
          <div className="footer-column">
            <h4>Learn more</h4>
            <ul>
              <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/about'); }}>About MoneyMap</a></li>
